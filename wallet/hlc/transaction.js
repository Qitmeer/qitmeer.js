...
Transaction.prototype.getHash = function () {
    return hash.dblake2b256B(this.toBuffer(undefined, undefined, Transaction.TxSerializeNoWitness))
};
...
Transaction.prototype.getHashFull = function () {
    ...
    const witnessHash = hash.dblake2b256B(this.toBuffer(undefined, undefined, Transaction.TxSerializeOnlyWitness))
    return hash.dblake2b256B(Buffer.concat([prefixHash, witnessHash]))
};
...
Transaction.prototype.hashForSignature = function (inIndex, prevOutScript, hashType) {
    ...
    const prefixHash = hash.blake2b256B(prefixBuffer);
    const witnessHash = hash.blake2b256B(witnessBuffer);
    return hash.blake2b256B(Buffer.concat([typeBuffer, prefixHash, witnessHash]))
};
